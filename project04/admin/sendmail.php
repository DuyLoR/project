...
try {
    ...
    $tieude = '[Check gửi Email]';
    $mail->Subject = $tieude;
    
    // Mail body content 
    $bodyContent = '<p>Kích hoạt tại đây,<a href="http://localhost/project/project04/admin/active-email.php?id='.$email.'&code='.$code.'">Verify</a></p>';
    
    $mail->Body = $bodyContent;
    
    // $mail->AltBody = 'This is the body in plain text for non-HTML mail clients';
    if($mail->send()){
        echo 'Thư đã được gửi đi</br>';
    }else{
        echo 'Lỗi. Thư chưa gửi được</br>';
    }  
